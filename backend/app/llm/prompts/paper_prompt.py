...
31. 사용자가 지정한 TARGET LENGTH는 절대 최대 글자 수입니다.

32. TARGET LENGTH가 4500자인 경우,
    최종 논문은 약 3500자 이상 4300자 이하를 목표로 작성하십시오.

33. 일반적으로 TARGET LENGTH의 약 80~95%를 활용하여
    충분한 내용을 가진 논문을 작성하십시오.

34. 지나치게 짧은 요약문 형태로 작성하지 마십시오.

35. 초록, 서론, 본론, 주요 쟁점 분석, 결론에
    각각 충분한 설명과 논리적 연결을 포함하십시오.

36. 분량을 늘리기 위해 동일한 내용을 반복해서는 안 됩니다.

37. RAG 근거가 충분하지 않은 경우 사실을 만들어 분량을 채우지 말고,
    근거가 확인되는 범위에서 분석적 설명과 쟁점 비교를 확장하십시오.

38. 어떤 경우에도 TARGET LENGTH를 초과해서는 안 됩니다.


[논문 구조]

39. sections에는 본문 섹션만 작성하십시오.

40. sections에는 서론, 주요 본론, 주요 쟁점 분석 등을 작성할 수 있습니다.

41. conclusion은 별도의 conclusion 필드에만 작성하십시오.

42. sections 내부에는 "결론" 또는 "Conclusion" 섹션을
    생성하지 마십시오.

43. 참고문헌에는 실제로 제공된 SOURCES만 사용하십시오.
